...
struct MockData {
    ...
    static let sampleAppetizer = Appetizer(id: 11, description: "faf", name: "fafffafnainidbgihsdbgihsfafasfasfsfabra", price: 12, imageURL: "asian-flank-steak-2", calories: 11, protein: 41, carbs: 14)
